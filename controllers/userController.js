...
class userController {
  async getUserApi(token) {
    return await axios
      .post("http://pocobook.ir/api/v1/getUsers", {
        token: token,
      })
  ...
  async getAdminApi(token) {
    return await axios
      .post("http://app.mahanteymouri.ir/mahant-api/private/getAdminId", {
        token: token,
      })
      .then(function (response) {
        // handle success
  ...
  async getUsersApi(req, res, next) {
    await axios
      .post(
        "http://app.mahanteymouri.ir/mahant-api/private/getAllUserHastChat",
        {
          token:
            "iZQEbfTRBNGke1wxuQS65oJQRTcGh08no3XBHle31AhvPRen7BhsyycQqKFaKYsvVu15SIf1ZMcLuIcz2TR0oKCA5LTS4df2g2XsZ44xs44PhqzeJv9us8CTGvyZUaOELKgrfEZ1siQPp8YRzGnp3f",
        }
      )
      .then(function (response) {
  ...
  async getChatTitlesApi(req, res, next) {
    await axios
      .post("http://app.mahanteymouri.ir/mahant-api/v1/getChatTitles", {
  ...
  async getAdminInfoApi(req, res, next) {
    await axios
      .get("http://app.mahanteymouri.ir/mahant/get-info")
      .then(function (response) {
  ...
  async updateOnlineUser(token, status) {
    await axios
      .post("http://app.pocobook.ir/api/v1/chat/updateOnlineChatStatus", {
        status: status,
        token: token,
      })
      .then(function (response) {
